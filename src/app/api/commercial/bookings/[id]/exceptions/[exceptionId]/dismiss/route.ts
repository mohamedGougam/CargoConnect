...
import { dismissOperationalException } from "@/server/exceptions/manageException";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

/** POST /api/commercial/bookings/:id/exceptions/:exceptionId/dismiss */
export async function POST(
  ...
  const result = await dismissOperationalException({
    bookingId: id,
    exceptionId,
    userId: user.id,
    note,
